...
String handShake(){
  ...
  ptr +="div{display: flex;  justify-content: center; align-items: center; margin: 0px auto;background-color: width:100%; height: 200px; #eee; margin-top: 50px;}\n";
